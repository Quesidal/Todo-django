...
from .views import TaskAddView, TaskDeleteView, TaskUpdateView, TaskDoneView, TaskListForProjectView, TaskListTodayView, \
    TaskListWeekView, TaskArchiveView, ProjectAddView, ProjectUpdateView, ProjectDeleteView
